...
class SQUADBubblev4(PointingTechnique):
	...
	def updateSQUADQuadrants(self):
		...
		if y >= 1.0 and x >= (0.5-(y-0.5)) and x <= (0.5+(y-0.5)):
		...
		if y < 0.0 and x >= (0.5-((1.0-y)-0.5)) and x <= (0.5+((1.0-y)-0.5)):
		...
		if x < 0.0 and y >= (0.5-((1.0-x)-0.5)) and y <= (0.5+((1.0-x)-0.5)):
		...
		if x >= 1.0 and y >= (0.5-(x-0.5)) and y <= (0.5+(x-0.5)):
