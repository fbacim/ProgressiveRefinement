...
from SQUADBubblev1 import SQUADBubblev1
from SQUADBubblev2 import SQUADBubblev2
from SQUADBubblev3 import SQUADBubblev3
from SQUADBubblev4 import SQUADBubblev4
from SQUADBubblev5 import SQUADBubblev5
from SQUADBubblev6 import SQUADBubblev6
from SQUADBubblev7 import SQUADBubblev7
from SQUADBubblev8 import SQUADBubblev8
from Raycasting import Raycasting
from ContinuousZoom import ContinuousZoom
from DiscreteZoom import DiscreteZoom
from CombinedZoomv1 import CombinedZoomv1
from CombinedZoomv2 import CombinedZoomv2
from CombinedZoomv3 import CombinedZoomv3
from CombinedZoomv4 import CombinedZoomv4
from ExpandBubblev1 import ExpandBubblev1
from ExpandBubblev2 import ExpandBubblev2
from ExpandBubblev3 import ExpandBubblev3
from ExpandBubblev4 import ExpandBubblev4
...
class Globals:
	...
	#technique = InteractionTechnique.CombinedZoomv2
	#technique = InteractionTechnique.CombinedZoomv3
	#technique = InteractionTechnique.CombinedZoomv4
	#technique = InteractionTechnique.ContinuousZoom
	#technique = InteractionTechnique.DiscreteZoom
	#technique = InteractionTechnique.SQUADBubblev2
	#technique = InteractionTechnique.SQUADBubblev3
	#technique = InteractionTechnique.SQUADBubblev4
	#technique = InteractionTechnique.SQUADBubblev5
	#technique = InteractionTechnique.SQUADBubblev6
	#technique = InteractionTechnique.SQUADBubblev7
	#technique = InteractionTechnique.SQUADBubblev8
	#technique = InteractionTechnique.ExpandBubblev1
	#technique = InteractionTechnique.ExpandBubblev2
	#technique = InteractionTechnique.ExpandBubblev3
	#technique = InteractionTechnique.ExpandBubblev4
	#technique = InteractionTechnique.ExpandBubblev5
	#technique = InteractionTechnique.ExpandBubblev61
	#technique = InteractionTechnique.BubbleCursor
	#technique = InteractionTechnique.DyCoDiR
	technique = InteractionTechnique.Raycasting
...
def cycleTechniqueForward():
	...
	resetObjects()
	for i in range(InteractionTechnique.size):
...
if __name__ == '__main__':
	...
	if is900Sensor.valid():
		...
		viz.setOption('viz.fullscreen.x',0)#1280)
		viz.setOption('viz.fullscreen.y',0)
		viz.setOption('viz.fullscreen.width',2800)
		viz.setOption('viz.fullscreen.height',1050)
		viz.setOption('viz.fullscreen.monitor',3)
		viz.go(viz.FULLSCREEN)
		#viz.go()
	...
	index = 0
	while index != max:
		if viz.MainWindow.isCulled(children[index]):
	...
	# SQUAD
	selectionTechnique.append(SQUAD(children))
	
	# Bubble Cursor 3D + SQUAD
	selectionTechnique.append(SQUADBubblev1(children))
	selectionTechnique.append(SQUADBubblev2(children))
	selectionTechnique.append(SQUADBubblev3(children))
	selectionTechnique.append(SQUADBubblev4(children))
	selectionTechnique.append(SQUADBubblev5(children))
	selectionTechnique.append(SQUADBubblev6(children))
	selectionTechnique.append(SQUADBubblev7(children))
	#selectionTechnique.append(SQUADBubblev8(children,[size,pos[0],pos[1],pos[2]])) # with octree
	selectionTechnique.append(SQUADBubblev8(children)) # without octree
	
	# Continuous Zoom
	selectionTechnique.append(ContinuousZoom(children,defaultHFOV,VFOV))
	
	# Discrete Zoom
	selectionTechnique.append(DiscreteZoom(children,defaultHFOV,VFOV))
	
	# Discrete+Continuous Zoom
	selectionTechnique.append(CombinedZoomv1(children,defaultHFOV,VFOV))
	selectionTechnique.append(CombinedZoomv2(children,defaultHFOV,VFOV))
	selectionTechnique.append(CombinedZoomv3(children,defaultHFOV,VFOV))
	selectionTechnique.append(CombinedZoomv4(children,defaultHFOV,VFOV))
	
	# Expand + Bubble Cursor
	selectionTechnique.append(ExpandBubblev1(children))
	selectionTechnique.append(ExpandBubblev2(children))
	selectionTechnique.append(ExpandBubblev3(children))
	selectionTechnique.append(ExpandBubblev4(children))
	...
	BirdEyeView.setPosition([defaultPosition[0],defaultPosition[1]+250,defaultPosition[2]])
